...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TX_PROCESSOR_STACK_SIZE, 768);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_IMAGE_BOOT_OFFSET, 0x200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_MCUBOOT_IMGTOOL_SET_ROM_FIXED_ADDRESS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TF_PSA_CRYPTO_USER_CONFIG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RRAM_WEAR_TEST_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RRAM_WEAR_TEST_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_QCBOR_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_T_COSE_MODULE, 1);

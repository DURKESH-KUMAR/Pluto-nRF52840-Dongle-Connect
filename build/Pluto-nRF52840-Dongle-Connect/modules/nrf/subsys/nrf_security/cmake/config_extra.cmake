...
set(NRF_DIR                              C:/ncs/v3.4.0/nrf                                        CACHE STRING "nrf folder")
set(NRF_SECURITY_DIR                     C:/ncs/v3.4.0/nrf/subsys/nrf_security                    CACHE STRING "nrf_security folder")
set(TFM_BOARDS_NRF_DIR                   C:/ncs/v3.4.0/nrf/modules/trusted-firmware-m/tfm_boards  CACHE STRING "tfm_boards folder")
set(ZEPHYR_NRFXLIB_MODULE_DIR            C:/ncs/v3.4.0/nrfxlib                      CACHE STRING "nrfxlib folder")
set(ZEPHYR_OBERON_PSA_CRYPTO_MODULE_DIR  C:/ncs/v3.4.0/modules/crypto/oberon-psa-crypto            CACHE STRING "oberon-psa-crypto folder")
set(ZEPHYR_MBEDTLS_MODULE_DIR            C:/ncs/v3.4.0/modules/crypto/mbedtls                      CACHE STRING "mbedtls folder")

# This file is populated with the Mbed TLS config file names
set(CONFIG_MBEDTLS_CONFIG_FILE                          CACHE STRING "Mbed TLS config file")
set(CONFIG_TF_PSA_CRYPTO_CONFIG_FILE      nrf-psa-crypto-config.h        CACHE STRING "TF-PSA-Crypto config file (PSA_WANT)")
set(CONFIG_TF_PSA_CRYPTO_USER_CONFIG_FILE nrf-psa-crypto-user-config.h   CACHE STRING "TF-PSA-Crypto user config file (PSA_NEED)")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    C:/Users/Public/Documents/Pluto-nRF52840-Dongle-Connect/build/Pluto-nRF52840-Dongle-Connect/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      C:/Users/Public/Documents/Pluto-nRF52840-Dongle-Connect/build/Pluto-nRF52840-Dongle-Connect/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
